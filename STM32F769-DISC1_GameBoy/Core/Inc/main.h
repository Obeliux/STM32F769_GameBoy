...
#define NRF24_MOSI_Pin GPIO_PIN_9
#define NRF24_MOSI_GPIO_Port GPIOF
#define NRF24_MISO_Pin GPIO_PIN_8
#define NRF24_MISO_GPIO_Port GPIOF
#define NRF24_IRQ_Pin GPIO_PIN_4
#define NRF24_IRQ_GPIO_Port GPIOJ
...
#define NRF24_CE_GPIO_Port GPIOJ
#define NRF24_CSN_Pin GPIO_PIN_1
#define NRF24_CSN_GPIO_Port GPIOJ
